...
// Welcome show summary of current GoZebro instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the GoZebro JavaScript console!\n\n"

	// Print some generic GoZebro metadata
