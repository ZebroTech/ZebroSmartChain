...
// It can be used for testing that restart GoZebro normally.
...
// It can be used for testing that restart GoZebro after the crash.
...
// Tests a GoZebro restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a GoZebro was crashed and restarts with a broken snapshot. In this case the
...
// Tests a GoZebro was crashed and restarts with a broken snapshot. In this case
...
// Tests a GoZebro was running with snapshot enabled. Then restarts without
...
// Tests the GoZebro was running with snapshot enabled and resetHead is applied.
...
// Tests the GoZebro was running with a complete snapshot and then imports a few
