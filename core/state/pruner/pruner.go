...
pruning. Remember don't start the GoZebro without deleting the clean trie cache
otherwise the entire database may be damaged!

Check the command description "gozebro snapshot prune-state --help" for more details.
`
