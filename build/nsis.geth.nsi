...
# 1. install gozebro for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gozebro
# 5. create gozebro, attach and uninstall start menu entries
...
!define GROUPNAME "Zebrocoin"
!define APPNAME "GoZebro"
!define DESCRIPTION "Official Go implementation of the Zebrocoin protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gozebro is installed global
