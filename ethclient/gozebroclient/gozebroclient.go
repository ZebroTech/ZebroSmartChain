...
// Package gozebroclient provides an RPC client for gozebro-specific APIs.
package gozebroclient
...
// Client is a wrapper around rpc.Client that implements gozebro-specific functionality.
//
