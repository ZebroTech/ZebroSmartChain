...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gozebro.ipc", false, filepath.Join(os.TempDir(), "gozebro.ipc")},
		{"data", "gozebro.ipc", false, "data/gozebro.ipc"},
		{"data", "./gozebro.ipc", false, "./gozebro.ipc"},
		{"data", "/gozebro.ipc", false, "/gozebro.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gozebro.ipc", true, `\\.\pipe\gozebro.ipc`},
		{"data", "gozebro.ipc", true, `\\.\pipe\gozebro.ipc`},
		{"data", `\\.\pipe\gozebro.ipc`, true, `\\.\pipe\gozebro.ipc`},
	}
