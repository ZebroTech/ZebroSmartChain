...
var (
	walletCommand = &cli.Command{
		...
		ArgsUsage: "",
		Description: `
    gozebro wallet import /path/to/my/presale.wallet
		...
		Subcommands: []*cli.Command{
			{
				...
				Description: `
	gozebro wallet [options] /path/to/my/presale.wallet
...
`,
			},
			{
				...
				Description: `
    gozebro account update <address>
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gozebro account update [options] <address>
...
`,
			},
			{
				...
				ArgsUsage: "<keyFile>",
				Description: `
    gozebro account import <keyfile>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gozebro account import [options] <keyfile>
...
func accountCreate(ctx *cli.Context) error {
	cfg := gozebroConfig{Node: defaultNodeConfig()}
	// Load config file.
